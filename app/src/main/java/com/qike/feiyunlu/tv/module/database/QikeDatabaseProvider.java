...
public class QikeDatabaseProvider implements DatabaseProvider {

	private DatabaseProvider mExternalProvider;
	private DatabaseProvider mInternalProvider;
	public static final String DATABASE_NAME="qike_play_database.db";
	public static final String VIDEO_USER_DB="video_user_db";
	private String mExternalPath;
	private String mInternalPath;

	public QikeDatabaseProvider(Context context, String databasePath,String name) {
		mExternalPath = databasePath+name;

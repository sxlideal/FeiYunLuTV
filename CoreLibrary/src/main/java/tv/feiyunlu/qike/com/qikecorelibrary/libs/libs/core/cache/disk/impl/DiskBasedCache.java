...
package tv.feiyunlu.qike.com.qikecorelibrary.libs.libs.core.cache.disk.impl;
 ...
 * 
 *<p>磁盘存储的唯一实现类</p><br/>
 *<p>拥有静态成员类{@link CacheHeader},对序列化的{@link CacheEntry}进行头部包装
 * {@link DiskBasedCache}初始化时对所有缓存文件的头部进行内存预加载，映射序列化的文件
 * 以达到快速判断和减小内存消耗的目的</p>
 * @since 1.0.0
 * @author bigpie
 */
public class DiskBasedCache implements IDiskCache {
